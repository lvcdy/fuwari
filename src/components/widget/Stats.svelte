...
<div class="{`card-base p-3 ${className}`}" style={style}>
	<div 
	...
	{#if isExpanded}
		<div class="grid grid-cols-2 gap-2.5 mb-3">
			<div class="text-center rounded-xl bg-[var(--btn-regular-bg)] py-2.5">
				<div class="flex items-center justify-center gap-1 text-50 text-[0.7rem] mb-0.5">
					<Icon name="material-symbols:article-outline-rounded" class="text-sm"></Icon>
					<span>文章数</span>
				</div>
			...
			<div class="text-center rounded-xl bg-[var(--btn-regular-bg)] py-2.5">
				<div class="flex items-center justify-center gap-1 text-50 text-[0.7rem] mb-0.5">
					<Icon name="material-symbols:notes-rounded" class="text-sm"></Icon>
					<span>总字数</span>
				</div>
		...
		<div class="border-t border-dashed border-black/10 dark:border-white/[0.15] pt-3">
			...
			<div id="site-stats" class="grid grid-cols-2 gap-2.5">
				<div class="text-center rounded-xl bg-[var(--btn-regular-bg)] py-2.5">
					<div class="flex items-center justify-center gap-1 text-50 text-[0.7rem] mb-0.5">
						<Icon name="material-symbols:person-outline" class="text-sm"></Icon>
						<span>访问量</span>
					</div>
				...
				<div class="text-center rounded-xl bg-[var(--btn-regular-bg)] py-2.5">
					<div class="flex items-center justify-center gap-1 text-50 text-[0.7rem] mb-0.5">
						<Icon name="material-symbols:visibility-outline" class="text-sm"></Icon>
						<span>阅读量</span>
					</div>
